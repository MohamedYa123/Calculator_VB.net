...
Public Class Form5
    ...
    Private Sub Button13_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button13.Click
        ...
        c = My.Settings.stc
        Dim f20 As Decimal
        Dim stest10 As String = t1.Text

        stest10 = adap(stest10)

        For f20 = CDec(Calc(adap(start1.Text))) To CDec(Calc(adap(end1.Text))) Step CDec(Calc(adap(step1.Text)))

            Try
                l2.Items.Add(Calc(adap(stest10.Replace("N", CStr("(" & CStr(f20) & ")")))))
                l1.Items.Add(CStr(f20))
